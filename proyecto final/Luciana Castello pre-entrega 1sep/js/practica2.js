...
class Usuarios{
  constructor(nombreusuario, apellidousuario,dniusuario,direccion,email,telefono){
...
const usuario = new Usuarios ("Lucas" , "Alvarez", "34000888", "Laprida 123", "lucasalvarez@gmail.com", "1246754");
// Se solicita el ingreso al cliente , por ahora no vamos a validar el usuario
let ingresousuario = prompt ("Por favor identifiquese , ingrese su nombre "); 
